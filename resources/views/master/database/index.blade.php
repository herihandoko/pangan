...
@section('content_header')
    ...
    <!-- end breadcrumb -->
    <!-- begin page-header -->
    <h1 class="page-header">Basis Data <small>List</small></h1>
    <!-- end page-header -->
@endsection
@section('content')
    <!-- begin row -->
                ...
                <div class="panel-heading">
                    <div class="panel-heading-btn">
                        ...
                        @can('create', $data['moduleCode'])
                            <a href="{{ route('master.database.create') }}"
                    ...
                    <h4 class="panel-title">Basis Data - list</h4>
                </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#data-table').DataTable({
                processing: true,
                serverSide: true,
                ajax: "{!! route('master.database.fetch') !!}",
                columns: [{
                        data: 'id',
                        width: 75,
                        name: 'id'
                ...
                swal({
                    ...
                    function(result) {
                        if (result) {
                            $.ajax({
                                type: "DELETE",
                                url: "{{ route('master.database.destroy') }}",
                                dataType: 'JSON',
                                data: {
                                    'id': id,
                                },
