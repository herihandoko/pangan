...
@section('content_header')
    ...
    <!-- end breadcrumb -->
    <!-- begin page-header -->
    <h1 class="page-header">OPD <small>List</small></h1>
    <!-- end page-header -->
@endsection
@section('content')
    <!-- begin row -->
                ...
                <div class="panel-heading">
                    <div class="panel-heading-btn">
                        ...
                        @can('create', $data['moduleCode'])
                            <a href="{{ route('master.opd.create') }}"
                    ...
                    <h4 class="panel-title">OPD - list</h4>
                </div>
