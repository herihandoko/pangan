...
@section('content_header')
    ...
    <!-- end breadcrumb -->
    <!-- begin page-header -->
    <h1 class="page-header">Hardware <small>List</small></h1>
    <!-- end page-header -->
@endsection
@section('content')
    <!-- begin row -->
        ...
        <div class="col-md-12">
            ...
            <div class="panel panel-inverse">
                <div class="panel-heading">
                    ...
                    <h4 class="panel-title">Hardware - list</h4>
                </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#data-table').DataTable({
                processing: true,
                serverSide: true,
                ajax: "{!! route('inventory.hardware.fetch') !!}",
                columns: [
                    {
                        data: 'status',
                        name: 'status',
                ...
                swal({
                    ...
                    function(result) {
                        if (result) {
                            $.ajax({
                                type: "DELETE",
                                url: "{{ route('inventory.hardware.destroy') }}",
                                dataType: 'JSON',
                                data: {
                                    'id': id,
                                },
